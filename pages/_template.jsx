...
module.exports = React.createClass({
  ...
  render () {
    const blogiActive = includes(this.props.location.pathname, '/blogi/')
            ...
            >
              ...
              <Span columns={8} last>
                <Link
                  to={prefixLink('/blogi/')}
                  style={{
                    background: blogiActive ? activeColors.bg : colors.bg,
                    color: blogiActive ? activeColors.fg : colors.fg,
                    float: 'right',
                    textDecoration: 'none',
